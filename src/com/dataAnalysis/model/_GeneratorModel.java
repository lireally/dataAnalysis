...
public class _GeneratorModel {
    ...
    public static void main(String[] args){
    	 // base model 所使用的包名
        String baseModelPackageName = "com.dataAnalysis.model.base"; 
        // base model 文件保存路径
        System.out.println(PathKit.getRootClassPath());
        String baseModelOutputDir = PathKit.getRootClassPath() + "/../../src/com/dataAnalysis/model/base";
        System.out.println(PathKit.getRootClassPath());
        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.dataAnalysis.model";
        ...
        // 添加不需要生成的表名
        // gernerator.addExcludedTable("departmentcostreport");
